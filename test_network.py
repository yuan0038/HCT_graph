...
from DinoDataloader import GraphDataset
import warnings
warnings.filterwarnings("ignore")
from vit_graph import vit_small, DINOHead
...
def get_args_parser():
    ...
    # Misc
    parser.add_argument('--data_path', default='/home/ubuntu/lxd-workplace/lzy/FewShotLearning/dataset/Mini-ImageNet/train_train', type=str,
        help='Please specify path to the ImageNet training data.')
    parser.add_argument('--output_dir', default="""/home/ubuntu/lxd-workplace/lzy/FewShotLearning/HCT_graph/results/miniImageNet
...
def train_dino(args):
    ...
    teacher = vit_small(in_chans=args.in_chans, embed_dim=args.embed_dim, )
    ...
    teacher = utils.MultiCropWrapper_hct(
        teacher,
        DINOHead(12, args.out_dim, args.use_bn_in_head), 'teacher'
    )
   ...
   # student_state_dict = {k.replace('backbone.','',1):v for k,v in student.state_dict().items()}
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, surrogate_loss1,
                                      surrogate_loss2,
